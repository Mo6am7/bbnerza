...
let pe4 = document.getElementById("pe4")
let pe5 = document.getElementById("pe5")
...
function jiR(){
     if(pe1.value !="" && pe2.value !=""){
         let qw =  +pe1.value/100 * +pe2.value/100
         let et = qw * 100
         outp1.innerHTML = et
}
}
function iR(){
     if(pe5.value !="" && pe3.value !=""){
         let qow =  +pe3.value/100 + +pe4.value/100 + +pe5.value/100 ;
         let rti = qow * 100
         outp2.innerHTML = rti
}
}